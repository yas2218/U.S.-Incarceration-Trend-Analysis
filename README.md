...
* **Normalized Incarceration Rate (rate_per_100k):** Relying on raw prison population counts over time introduces a significant confound due to general population growth. To control for this, a normalized value was constructed:
