...
$$\text{Rate per 100,000} = \left( \frac{\text{Total Prison Population}}{\text{Total General Population}} \right) \times 100,000$$
...
### + tudeyverse: a collection of core packages (readr, dplyr, ggplot2) used for data import, manipulation, and visualization.
